...
printf "\n" >> "${DestFile}"
printf "%s\n" '#define kBldOpts "-br 36 -t 3dsa -sound 1 -speed 2 -bg 1 -as 0 -ta 0"' >> "${DestFile}"
...
printf "%s\n" '	$(DEVKITARM)/bin/arm-none-eabi-gcc "src/KBRDEMDV.c" -o "bld/KBRDEMDV.o" $(mk_COptions)' >> "${DestFile}"
printf "%s\n" 'bld/SNDEMDEV.o: src/SNDEMDEV.c cfg/CNFGGLOB.h' >> "${DestFile}"
printf "%s\n" '	$(DEVKITARM)/bin/arm-none-eabi-gcc "src/SNDEMDEV.c" -o "bld/SNDEMDEV.o" $(mk_COptions)' >> "${DestFile}"
